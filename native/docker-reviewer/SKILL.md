...
description: Use when reviewing Dockerfiles or docker-compose files — image pinning, layer hygiene, secrets, root user, healthchecks and compose best practices.
---
