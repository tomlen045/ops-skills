...
description: Use when production is down, an outage, 5xx errors, latency spike, error-rate alert, PagerDuty page, or any production incident — runs SEV triage, escalation and structured troubleshooting. Guides incident response like a senior SRE.
---
