...
description: Use when setting up monitoring, writing PromQL, or designing Prometheus/VictoriaMetrics alert rules that page when they should and stay quiet when they shouldn't.
---
